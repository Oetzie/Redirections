<?php
	...
	$_lang['redirections.old']								= 'Old URL';
	$_lang['redirections.old_desc']							= 'The old URL of the redirect.';
	$_lang['redirections.new']								= 'new URL';
	$_lang['redirections.new_desc']							= 'The new URL of the redirect to redirect to.';
